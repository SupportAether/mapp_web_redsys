...
def encode_parameters(merchant_parameters):
    ...
    return ''.join(unicode(base64.encodebytes(parameters), 'utf-8').splitlines())
...
"""
def encrypt_order_with_3DES(Ds_Merchant_Order: str):
...
"""
def sign_hmac256(order_encrypted: bytes, Ds_MerchantParameters: str):
